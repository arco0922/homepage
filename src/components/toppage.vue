<template>
  <div class="all__container">
    ...
    <div id="works" class="section">
      ...
      <transition name="content">
        <div class="works__contents" :style="worksstyle" v-show="showcontent">
          <div v-for="(work, idx) in works" :key="idx" class="work" :style="workstyle">
            <img :src="work.imgsrc" class="thumbnails" @click="gotodetail(work.link)" />
            <h4>{{ work.title }}</h4>
